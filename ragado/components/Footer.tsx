...
export function Footer() {
  return (
    <footer className="bg-[#0F112A] text-white px-6 md:px-12 pt-20 pb-16 rounded-t-[50px] mt-24">
      <div className="max-w-7xl mx-auto space-y-14">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
          {/* Section 1: Links */}
          <div className="flex flex-col gap-3">
            <SnakeLink href="#" className="text-[16px] text-white font-normal">
              Privacy Policy
            </SnakeLink>
            <SnakeLink href="#" className="text-[16px] text-white font-normal">
              Terms of Service
          ...
          <div className="md:text-right">
            <SnakeLink href="mailto:support@ragadobrokers.com" className="text-[16px] text-white font-normal">
        ...
        <div className="space-y-16">
          <p className="text-[12px] text-white font-normal leading-relaxed max-w-4xl">
